...
namespace Acme.BookStore4.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update BookStore4DbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update BookStore4EfCoreEntityExtensionMappings to extend the IdentityUser entity
